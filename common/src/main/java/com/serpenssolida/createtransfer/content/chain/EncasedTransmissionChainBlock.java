...
public class EncasedTransmissionChainBlock extends AbstractTransmissionChainBlock implements EncasedBlock, ISpecialBlockItemRequirement
{
	...
	public InteractionResult onWrenched(BlockState state, UseOnContext context)
	{
		...
		BlockState newState = CreateTransferBlocks.TRANSMISSION_CHAIN.getDefaultState()
	...
	{
		return ItemRequirement.of(CreateTransferBlocks.TRANSMISSION_CHAIN.getDefaultState(), blockEntity);
	}
}
